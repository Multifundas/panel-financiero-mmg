  ...
  el.innerHTML = `
    ...
    <div class="card" style="margin-bottom:12px;padding:10px 16px;">
      <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin-bottom:8px;">
        <input type="date" id="filterMovDesde" class="form-input" style="padding:8px 12px;font-size:17px;min-height:auto;width:130px;" onchange="filterMovimientos()">
        <input type="date" id="filterMovHasta" class="form-input" style="padding:8px 12px;font-size:17px;min-height:auto;width:130px;" onchange="filterMovimientos()">
        <select id="filterMovAnio" class="form-select" style="padding:8px 12px;font-size:17px;min-height:auto;width:90px;" onchange="filterMovimientos()">
        ...
        <select id="filterMovCuenta" class="form-select" style="padding:8px 12px;font-size:17px;min-height:auto;width:185px;" onchange="filterMovimientos()">
          <option value="">Todas las cuentas</option>
          ${cuentaFilterOpts}
        </select>
        <input type="text" id="filterMovSearch" class="form-input" placeholder="Buscar..." style="padding:8px 12px;font-size:17px;min-height:auto;flex:1;min-width:120px;" oninput="filterMovimientos()">
      </div>
      <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap;">
        <button class="btn btn-secondary" onclick="exportarMovsFiltradosExcel()" style="padding:8px 14px;font-size:17px;flex:1;min-width:70px;">
          <i class="fas fa-file-excel" style="margin-right:3px;"></i>Excel
        </button>
        <button class="btn btn-secondary" onclick="exportarMovsFiltradosPDF()" style="padding:8px 14px;font-size:17px;flex:1;min-width:60px;background:rgba(239,68,68,0.1);border-color:rgba(239,68,68,0.3);color:#ef4444;">
          <i class="fas fa-file-pdf" style="margin-right:3px;"></i>PDF
        </button>
        <button class="btn btn-secondary" onclick="openPlantillasRecurrentes()" style="padding:8px 14px;font-size:17px;flex:1;min-width:90px;">
          <i class="fas fa-sync-alt" style="margin-right:3px;"></i>Plantillas
        </button>
        <button class="btn btn-secondary" onclick="openCargaMasiva()" style="padding:8px 14px;font-size:17px;flex:1;min-width:100px;">
          <i class="fas fa-file-excel" style="margin-right:3px;"></i>Carga Masiva
        </button>
        <button class="btn btn-secondary" onclick="openPdfImport()" style="padding:8px 14px;font-size:17px;flex:1;min-width:80px;border-color:var(--accent-amber);color:var(--accent-amber);">
          <i class="fas fa-upload" style="margin-right:3px;"></i>Cargar PDF
        </button>
        <button class="btn btn-secondary" onclick="openTransferenciaModal()" style="padding:8px 14px;font-size:17px;flex:1;min-width:110px;border-color:var(--accent-purple);color:var(--accent-purple);">
          <i class="fas fa-exchange-alt" style="margin-right:3px;"></i>Transferencia
        </button>
        <button class="btn btn-secondary" onclick="cierreMensual()" style="padding:8px 14px;font-size:17px;flex:1;min-width:80px;border-color:var(--accent-green);color:var(--accent-green);">
          <i class="fas fa-calendar-check" style="margin-right:3px;"></i>Cierre
        </button>
        <button class="btn btn-primary" onclick="editMovimiento(null)" style="padding:8px 14px;font-size:17px;flex:1;min-width:80px;">
    ...
    return `
      <tr>
        ...
        <td style="text-align:center;">
          <button class="btn btn-secondary" style="padding:8px 14px;font-size:17px;margin-right:4px;" onclick="editMovimiento('${m.id}')">
            <i class="fas fa-edit"></i>
          </button>
          <button class="btn btn-danger" style="padding:8px 14px;font-size:17px;" onclick="deleteMovimiento('${m.id}')">
    ...
    rowsHTML = plantillas.map(function(p) {
      ...
      return '<tr>' +
        ...
        '<td style="text-align:center;white-space:nowrap;">' +
          ...
          '</button>' +
          '<button class="btn btn-secondary" style="padding:8px 14px;font-size:17px;margin-right:4px;" onclick="editPlantillaRecurrente(\'' + p.id + '\')" title="Editar">' +
            '<i class="fas fa-edit"></i>' +
          '</button>' +
          '<button class="btn btn-danger" style="padding:8px 14px;font-size:17px;" onclick="deletePlantillaRecurrente(\'' + p.id + '\')" title="Eliminar">' +
            '<i class="fas fa-trash"></i>' +
          '</button>' +
        '</td>' +
      '</tr>';
