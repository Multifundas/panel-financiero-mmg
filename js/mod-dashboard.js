...
function auditoriaRendGastos() {
  ...
  var rows = periodos.map(function(per) {
    ...
    var out = '<tr style="background:#dbeafe;border-top:2px solid #1d4ed8">'
      ...
      +   '<div style="display:flex;justify-content:space-between;align-items:flex-start;min-width:0">'
      +     '<span style="font-weight:700;font-size:12px;color:#1e3a5f;white-space:nowrap;padding-top:4px">' + mesLabel(per) + '</span>'
      +     '<div style="text-align:right;white-space:nowrap;padding-left:20px">'
      +       '<div style="font-size:8px;color:#64748b;font-weight:600;text-transform:uppercase;letter-spacing:.05em">Diferencia</div>'
      +       '<div style="font-weight:700;font-size:12px;color:' + diffColor + '">' + fmt(diff) + '</div>'
      +     '</div>'
      +   '</div>'
      + '</td>'
      + '<td colspan="3" style="padding:5px 10px;text-align:center">'
